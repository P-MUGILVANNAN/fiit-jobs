...
const ItIcon = () => {
  <img src="https://fiit.co.in/wp-content/uploads/2024/07/software-developer.png" alt="" />
}
  ...
  return (
    <div className="space-y-16">
      ...
      <section className="relative bg-white rounded-lg shadow-md overflow-hidden -mt-8">
        <img src="public\fiit_logo.png" alt="Modern Office" className="w-full h-64 opacity-50 object-cover" />
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <img src="public\fiit_icon.webp" alt="Team collaborating" className="rounded-lg shadow-xl" />
        </div>
      </section>
